...
CKEDITOR.editorConfig = function( config ) {
	...
	config.removeButtons = 'Source,Save,NewPage,Preview,Print,Cut,Copy,Paste,Find,SelectAll,Scayt,Form,Checkbox,Radio,TextField,Textarea,Select,Button,ImageButton,HiddenField,CopyFormatting,RemoveFormat,Outdent,Indent,CreateDiv,BidiLtr,BidiRtl,Unlink,Anchor,Flash,Table,Smiley,PageBreak,Iframe,About,Maximize,ShowBlocks';
